...
function randomData(req, res){
	...
	var randomizedRecords = jsonTools.randomizeData(jsonObj, fileName, iterValue, fileSelector);
	res.render('actionconfirm', { action: 'Randomize', content: JSON.stringify(randomizedRecords, null, 1) });
}
